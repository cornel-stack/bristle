...
- [X] T020 **Bundle recheck #2 (authoritative)**: production build; record First Load JS for `/onboarding/role` + `/onboarding/categories`. **Watch >110 KB; HARD BLOCK >130 KB** — fix before STOP 7. (dep: T019)
